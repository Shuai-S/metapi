...
export const sidebarGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/customer-balances', label: '客户余额', icon: <svg className="sidebar-item-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M12 6c-3.314 0-6 1.12-6 2.5S8.686 11 12 11s6-1.12 6-2.5S15.314 6 12 6z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M6 8.5v7c0 1.38 2.686 2.5 6 2.5s6-1.12 6-2.5v-7M6 12c0 1.38 2.686 2.5 6 2.5s6-1.12 6-2.5" /></svg> },
          ...
          <PageTransition>
            <Suspense fallback={<RouteLoadingFallback />}>
              <Routes>
                ...
                <Route path="/customer-balances" element={<CustomerBalances />} />
